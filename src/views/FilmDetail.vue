            ...
            <ul>
              ...
              <li v-for="(comment, index) in film.comment2Details" :key="index">
                <div class="content_L5_2_1">
                  <img
                    :src="comment.userId2Details[0].userImg"
                    alt=""
                  />
                  <i class="v1"></i>
                </div>
